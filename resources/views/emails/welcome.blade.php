                        ...
                        <table style="margin: 0 auto;" cellpadding="0" cellspacing="0" width="60%">
                          <tr>
                            ...
                            <p style="text-align: justify;">
                                <p>Bienvenue à l'application <strong>{{ $user->firstname}} {{ $user->lastname }} </strong></p>
                                <p>Votre login : <strong>{{ $user->email }}</strong> </p>
                                <p>Votre mot de passe : <strong>{{ $user->cin }}</strong></p>
                    ...
                    <td>
                      <div><!--[if mso]>
                        <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="http://" style="height:50px;v-text-anchor:middle;width:200px;" arcsize="8%" stroke="f" fillcolor="#178f8f">
                          ...
                          <center>
                        <![endif]-->
                            <a href="http://localhost/stage-pfe/public/login" style="background-color:#178f8f;border-radius:4px;color:#ffffff;display:inline-block;font-family:Helvetica, Arial, sans-serif;font-size:16px;font-weight:bold;line-height:50px;text-align:center;text-decoration:none;width:200px;-webkit-text-size-adjust:none;">
                    ...
                    <center>
                      <table style="margin:0 auto;" cellspacing="0" cellpadding="0" class="force-width-80">
                        <tr>
                          ...
                          <br>
                          <br>
                            <span style="color:#ffffff;">Iset bizerte</span> <br>
                            <p>Tel : +216 72 57 06 01</p>
                            <p>Fax : +216 72 572 455 </p>
                          </td>
