...
<br>
    <div class="card">
        ...
        <div class="card-header">
                <i class="fa fa-edit"></i> Demandes D'Encadrements Par Enseignant (Rejeté)
        </div>
                ...
                @foreach($alldata as $data)
                        <tr role="row" class="odd">
                                ...
                                <td  class="text-center">
                                        ...
                                        &nbsp;&nbsp;En Attente :
                                        <a href="#" style="text-decoration:none;" onclick='waiting({{$data->id}})'><i class="icon-clock" style="font-size:25px;color:red"></i></a>
                                </td>
