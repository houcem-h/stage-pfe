...
<div class="container">
    <div class="col-md-6 col-md-offset-3">
        <a class="btn btn-default" href="{{auth()->user()->Dashboard}}" style="margin-bottom:50px;">Go Back</a>
        @forelse($internships as $internship)
            <div class="panel panel-default">
                <div class="panel-heading">
                     <strong>Stagaire</strong> <a href="/internships/{{$internship->id}}"> {{$internship->registration->studentRecord->firstname}}</a>
                </div>
